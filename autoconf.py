...
if ip.prefixlen == 17:
	...
	IPv70     = list(ip.subnet(26))[1]
	IPv90     = list(ip.subnet(27))[1]
	IPv60     = list(ip.subnet(25))[1]
	IPv110    = list(ip.subnet(24))[2]
	IPv30 	  = list(ip.subnet(24))[1]
	IPv200 	  = list(ip.subnet(22))[1]
	IPv201 	  = list(ip.subnet(22))[2]
	IPv202 	  = list(ip.subnet(22))[3]
	IPv203 	  = list(ip.subnet(22))[4]
	IPv204 	  = list(ip.subnet(22))[5]
	IPv800 	  = list(ip.subnet(21))[3]
	IPv801 	  = list(ip.subnet(21))[4]
	IPv802 	  = list(ip.subnet(21))[5]
	IPv803 	  = list(ip.subnet(21))[6]
	IPv804 	  = list(ip.subnet(21))[7]
	IPv300 	  = list(ip.subnet(20))[5]
	IPv600	  = list(ip.subnet(24))[3]
	IPv700	  = list(ip.subnet(20))[6]
if ip.prefixlen == 22:
	IP_uplink = list(list(ip.subnet(29))[0])[6]
	IP_gateway= list(ip.subnet(29))[0]
